                    ...
                    <div class="order-2 col-lg-5 d-flex align-items-center order-lg-1" data-aos="fade-up"
                        ...
                        <div class="content">
                            ...
                            <ul>
                                ...
                                <li><i class="flex-shrink-0 bi bi-patch-check"></i> Exercícios para testar o seu aprendizado.</li>
                                <li><i class="flex-shrink-0 bi bi-brightness-high"></i>Simulações de exames práticos e teóricos .</li>
                            </ul>
                            <a href="#" class="btn more-btn">Saiba Mais</a>
                        </div>
                    </div>
